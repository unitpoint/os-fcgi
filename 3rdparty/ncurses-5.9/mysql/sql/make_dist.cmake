...
SET(CMAKE_CURRENT_SOURCE_DIR "/tmp/os-igor/mysql/sql")
SET(CMAKE_CURRENT_BINARY_DIR "/tmp/os-igor/ncurses-5.9/mysql/sql")
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "mysql-5.5.32")
...
SET(PACKAGE_DIR  ${CMAKE_CURRENT_BINARY_DIR}/${CPACK_SOURCE_PACKAGE_FILE_NAME})
...
IF(NOT BZR_EXECUTABLE)
  ...
  IF(CMAKE_CURRENT_SOURCE_DIR STREQUAL CMAKE_CURRENT_BINARY_DIR)
    ...
    CONFIGURE_FILE(${CMAKE_CURRENT_BINARY_DIR}/sql/sql_yacc.cc
       ${CMAKE_CURRENT_BINARY_DIR}/sql_yacc.cc COPY_ONLY)
    CONFIGURE_FILE(${CMAKE_CURRENT_BINARY_DIR}/sql/sql_yacc.h 
       ${CMAKE_CURRENT_BINARY_DIR}/sql_yacc.h COPY_ONLY)
    ...
    CONFIGURE_FILE(${CMAKE_CURRENT_BINARY_DIR}/sql_yacc.cc
       ${CMAKE_CURRENT_BINARY_DIR}/sql/sql_yacc.cc COPY_ONLY)
    CONFIGURE_FILE(${CMAKE_CURRENT_BINARY_DIR}/sql_yacc.h 
       ${CMAKE_CURRENT_BINARY_DIR}/sql/sql_yacc.h COPY_ONLY)
    FILE(REMOVE ${CMAKE_CURRENT_BINARY_DIR}/sql_yacc.cc)
    FILE(REMOVE ${CMAKE_CURRENT_BINARY_DIR}/sql_yacc.h)
  ENDIF()
...
ENDIF()
CONFIGURE_FILE(${CMAKE_CURRENT_BINARY_DIR}/support-files/${SPECFILENAME}
